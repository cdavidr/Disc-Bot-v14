...
const invoke = (interaction) => {
	...
	for (const idx of winners) {
		...
		let user = interaction.guild.members.cache.get(rows[idx].Discord) || interaction.guild.members.cache.find(m => m.user.tag.toLowerCase() == rows[idx].Discord.toLowerCase()) || interaction.guild.members.cache.find(m => m.nickname.toLowerCase() == rows[idx].Discord.toLowerCase())
		tagged += `${user}` + " ";
	}
